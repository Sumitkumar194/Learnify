      ...
      <section className="signup-page">
        ...
        <div className="signup-right">
          <div className="signup-form-wrap">
            ...
            {signupError && (
              <p className="error-text w-full text-center text-red-800 font-bold policy-error-text">
                {signupError}
              </p>
            )}
            <div
              className={`field-group ${errors.name ? "field-group-error" : ""}`}
            >
              <label htmlFor="name">Full Name</label>
              <div
                className={`input-wrap ${errors.name ? "input-wrap-error" : ""}`}
              >
              ...
              {errors.name && (
                <strong className="error-text">{errors.name}</strong>
              )}
            </div>

            <div
              className={`field-group ${errors.email ? "field-group-error" : ""}`}
            >
              <label htmlFor="email">Email</label>
              <div
                className={`input-wrap ${errors.email ? "input-wrap-error" : ""}`}
              >
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <rect
                    x="3"
              ...
              {errors.email && (
                <strong className="error-text">{errors.email}</strong>
              )}
            </div>

            <div
              className={`field-group password-group ${errors.password ? "field-group-error" : ""}`}
            >
              <label htmlFor="password">Password</label>
              <div
                className={`input-wrap ${errors.password ? "input-wrap-error" : ""}`}
              >
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <rect
                    x="5"
            ...
            <label
              className={`policy-row ${errors.agreeToPolicy ? "policy-row-error" : ""}`}
            >
              <input
                id="agreeToPolicy"
                name="agreeToPolicy"
